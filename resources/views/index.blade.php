...
<body>
        <header>
            <div class="logo">
                <img src="images/logo.png" alt="我的网站" class="img-responsive" />
            </div>
            <strong class="words">微信托管平台</strong>
            <nav class="menu">
            ...
            <div class="hotline">
                <a href="javascript:;"><span>18695275660</span></a><u></u>
            </div>
            <div class="menu-icon">
                <a href="javascript:;"><span class="glyphicon glyphicon-earphone"></span></a>
        ...
        <section class="video">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide nth1">
                        <div class="box">
                            <div class="left"></div>
                            <div class="right">
                                <span>年专注，微信营销</span><i></i>
                                <p>始于 2014 - 2015 展望未来<br />专注于设计体验，专业于解决方案</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="innerBox">
                <div class="news">
                    <span>NEWS :</span>
                    <a href="#" title="更多文章动态" class="more" target="_blank">more</a>
                    <ul>
                        <li><a href="#" target="_blank" title="钱都砸去哪里了，为什么你的网站推广没">钱都砸去哪里了，为什么你的网站推广没...</a></li>
                        <li><a href="#" target="_blank" title="2015羊年大吉，色彩云端网全体员工给新老">2015羊年大吉，色彩云端网全体员工给新老...</a></li>
                        <li><a href="#" target="_blank" title="国家发改委推行电子政务，微信微博上线">国家发改委推行电子政务，微信微博上线...</a></li>
                        <li><a href="#" target="_blank" title="不是“PC端 + 移动端”的网站就叫响应式">不是“PC端 + 移动端”的网站就叫响应式...</a></li>
                        <li><a href="#" target="_blank" title="黄色系网页配色分析与案例分享">黄色系网页配色分析与案例分享...</a></li>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="#" target="_blank">
                                <img src="images/1-1504291a0160-l.jpg" alt="万博法务网站建设项目" />
                                <p>网站设计<br /><strong>万博法务网站建设项目</strong><br />门户网站,红色</p></a>
                        </div>
                        <div class="swiper-slide">
                            <a href="#" target="_blank">
                                <img src="images/1-1504291649100-l.jpg" alt="中国影响力网站设计" />
                                <p>网站设计<br /><strong>中国影响力网站设计</strong><br />门户网站,蓝色,国有企业</p></a>
                        </div>
                        <div class="swiper-slide">
                            <a href="#" target="_blank">
                                <img src="images/1-150429164j40-l.jpg" alt="北京粮食科技研究所网站" />
                                <p>网站设计<br /><strong>北京粮食科技研究所网站</strong><br />官方网站,企业网站,绿色</p></a>
                        </div>

                    </div>
                </div>
                <a href="#" title="欣赏更多网站建设案例" class="more" target="_blank">MORE</a>
            </div>
        </section>
        ...
        <section class="clients">
            <div class="box">
                <div class="caption">
                    <i></i><span>他们与NIUSIR微信平台长期合作</span>
                    <br class="clear" />
                </div>
                <ul class="items list-inline">
        ...
        <section class="aboutus">
            ...
            <div class="swiper-container items">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide nth2">
                        <strong>NIUSIR微信平台</strong>
                        <p>成立于2014年，坐落于济宁市经济技术开发区，是中国优秀的互联网服务提供商。自成立以来，专注于高端网站建设、移动互联应用、B/S架构系统研发、云服务器部署和运维，为企业客户的互联网应用提供一站式服务。</p>
                        <p>我们始终坚持以客户需求为导向，为追求用户体验设计，提供有针对性的项目解决方案，苏州亦昂人将不断地超越自我，挑战险峰！</p>
                    </div>
                    <div class="swiper-slide nth3">
                        ...
                        <ul>
                            ...
                            <li>2011年<u>-</u>成功注册 " 色彩云端 " 商标，树立品牌</li>
        ...
        <section class="contact">
            <div class="box">
                <div class="above">
                    <div class="wechat"><img src="images/wechat_code.jpg" alt="扫描关注NIUSIR微信公众账号" /></div>
                    <div class="left">
                        <a href="tel:151-0537-0360" title="网站制作咨询热线" class="tel"></a>
                        <p>中国<u>·</u>山东<u>·</u>NIUSIR微信平台<br />联系电话：151-0537-0360<u>/</u>0313<br />地址：山东省济宁市市中区<br />邮编：272000<a href="#" target="_blank" class="job">[ 工作机会 ]</a></p>
                    </div>
                    <div class="right">
                        Email：niusir@qq.com<br />中文域名：NIUSIR微信平台.中国<u>/</u>www.niusir.net<br />Copyright 2014-2015<u></u>NIUSIR微信平台 版权所有<br />鲁ICP备13001922号-6<br />
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="dock">
            <ul class="icons">
                <li class="up"><i></i></li>
                <li class="im">
                    <i></i><p>网站建设咨询<br />在线沟通，请点我<a href="" target="_blank">在线咨询</a></p>
                </li>
                <li class="tel">
                    <i></i><p>建站咨询热线：<br />15105370360<br />售后服务热线：<br />15105370313</p>
                </li>
                <li class="wechat">
